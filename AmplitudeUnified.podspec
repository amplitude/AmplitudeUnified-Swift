amplitude_unified_version = "0.0.0" # Version is managed automatically by semantic-release, please don't change it manually
...
Pod::Spec.new do |s|
  ...
  s.dependency 'AmplitudeSwift', '>= 1.11.10', '< 2.0.0'

  s.ios.dependency 'AmplitudeSessionReplay', '>= 0.0.31', '< 2.0.0'
